...
using VideoStreamingDownloader._3CAT.Downloads;
using VideoStreamingDownloader._3CAT.Media;
using VideoStreamingDownloader._3CAT.Media.Extensions;
...
namespace VideoStreamingDownloader._3CAT
{
    internal partial class Main : Form
    {
        ...
        internal Main(_3CATService _3CATService)
        {
            InitializeComponent();
            SetText();

            _3CatService = _3CATService;
        ...
        private void SetText()
        {
            ...
            Select.Text = Resources.Translations.Strings.Select_files;
        }
        ...
        {
            _mediaOptions = await _3CatService.GetMediaOptions();
        ...
        private IEnumerable<Item> GetDownloadItems3CAT()
        {
        ...
        private void Download_Click(object sender, System.EventArgs e)
        {
            ...
            var items = GetDownloadItems3CAT();
